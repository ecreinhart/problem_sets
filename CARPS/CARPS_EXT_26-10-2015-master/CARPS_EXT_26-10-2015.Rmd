...
summary(df_aov <- aov(recall_proportion ~ RISKCONDITION*recall_type + Error(`PARTICIPANT#ID`/recall_type) + recall_type, data=df_subset))

#boxplot(recall_proportion ~ RISKCONDITION*recall_type,data=df_subset) #boxplot to visualize the data
